...
def is_file_ok(name, content):
    ...
    if extension not in ["png", "gif", "jpg", "jpeg", "bmp"]:
        ...
        # print(base)
        if (
            file_type != "data:image"
            or image_type not in ["png", "gif", "jpg", "jpeg", "bmp"]
            or base != "base64"
        ):
            return False
        else:
...
def _create_app():
    ...
    app.layout = dash.html.Div(
        [
                                    ...
                                    dash.html.Ul(
                                        [
                                            ...
                                            dash.html.Li(
                                                dash.html.A(
                                                    "Github",
                                                    href="https://github.com/simonerigoni/image_classifier_project",
                                                )
                                            ),
                                        ],
            ...
            dash.html.Div(
                [
                    dash.html.H1("Image Classifier Application", className="text-center"),
                    dash.html.P("Classify Images of Flowers", className="text-center"),
                    dash.html.Hr(),
                    dash.html.Div(
                        [
                            # dash.html.Div(
                            ...
                            dash.dcc.Upload(
                                ...
                                children=dash.html.Div(
                                    ["Drag and Drop or ", dash.html.A("Select File")]
                                ),
                                style={
                                    "width": "98%",
                                    "height": "60px",
    ...
    def parse_contents(contents, filename, date):
        ...
        return dash.html.Div(
            [
                ...
                # ,
                dash.html.Img(src=contents, style={"height": "75%", "width": "75%"})
                # , dash.html.Hr()
    ...
    def update_results(n_click):
        ...
        if len(files) == 0:
                        ...
                        dash.html.Div(
                            [
                                dash.html.Div(
                                    [
                                        dash.html.Img(
                                            src=get_encoded_image(
                                                sample_training_dataset[buffer_categories[0]]
                                            ),
                                            style={"height": "75%", "width": "75%"},
                                        ),
                                        dash.html.H5(buffer_categories[0]),
                                    ],
                                    className="col-sm-3",
                                ),
                                dash.html.Div(
                                    [
                                        dash.html.Img(
                                            src=get_encoded_image(
                                                sample_training_dataset[buffer_categories[1]]
                                            ),
                                            style={"height": "75%", "width": "75%"},
                                        ),
                                        dash.html.H5(buffer_categories[1]),
                                    ],
                                    className="col-sm-3",
                                ),
                                dash.html.Div(
                                    [
                                        dash.html.Img(
                                            src=get_encoded_image(
                                                sample_training_dataset[buffer_categories[2]]
                                            ),
                                            style={"height": "75%", "width": "75%"},
                                        ),
                                        dash.html.H5(buffer_categories[2]),
                                    ],
                                    className="col-sm-3",
                                ),
                                dash.html.Div(
                                    [
                                        dash.html.Img(
                                            src=get_encoded_image(
                                                sample_training_dataset[buffer_categories[3]]
                                            ),
                                            style={"height": "75%", "width": "75%"},
                                        ),
                                        dash.html.H5(buffer_categories[3]),
                                    ],
                                    className="col-sm-3",
                                ),
                            ],
            ...
            results.append(
                dash.html.Div(
                    [
                        dash.html.H2("Classification", className="text-center"),
                        dash.dcc.Graph(
                            figure=go.Figure(
                                data=[
                                    go.Bar(
                        ...
                        dash.html.Div(
                            [
                                dash.html.Div(
                                    [
                                        dash.html.H3("Image to classify"),
                                        dash.html.Img(
                                            src=get_encoded_image(image_filepath),
                                            style={"height": "75%", "width": "75%"},
                                        ),
                                    ],
                                    className="col-sm-6",
                                ...
                                dash.html.Div(
                                    [
                                        dash.html.H3(
                                            "Image from Training dataset for: {}".format(
                                                list(category_probability.keys())[0]
                                            )
                                        ),
                                        dash.html.Img(
                                            src=get_encoded_image(
